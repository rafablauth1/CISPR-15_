...
import {
  ...
  ClipboardCheck, Network, Ruler, Settings, Award, FlaskConical, Layers, Target, Tags, BadgeCheck, KanbanSquare, BookText,
} from 'lucide-react'
...
const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/glossario',           icon: BookText,       label: 'Glossário' },
    ],
  },
  {
    label: 'INTERNO',
